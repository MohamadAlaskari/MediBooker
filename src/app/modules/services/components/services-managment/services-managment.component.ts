...
export class ServicesManagmentComponent {
  ...
  constructor(private Servicemanagment: ServicemanagmentService,private fb: FormBuilder) {
    ...
    if (this.form.valid) {
          ...
          if (this.EditMode) {
            if (this.selectedserviceId !== null) {
              this.Servicemanagment.updateservice(this.selectedserviceId, type, description).subscribe({
                next: () => {
                  this.hideModal();
                  Swal.fire({
                    title: 'Success!',
