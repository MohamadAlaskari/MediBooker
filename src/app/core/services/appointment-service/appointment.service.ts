...
export class AppointmentService {
  ...
  createForDateRange(
    ...
    return this.apiService.post<Appointment[]>(
      `${this.appointmentsEndepoint.createForDateRange}`,
      body
    );
  }
  ...
  createreservation(
    ...
    return this.apiService.post<Reservation>(
      `${this.reservationEndepoints.create}`,
      body
    );
  }
  createMultipleAppointments(data: any[]): Observable<Appointment[]> {
    return this.apiService.post<Appointment[]>(
      `${this.appointmentsEndepoint.createMultiple}`,
      data
    );
  }
  deletereservation(id: string): Observable<string> {
    ...
    return this.apiService.delete<string>(
      `${this.reservationEndepoints.delete}?${params.toString()}`
    );
  }
  ...
  deleteappointment(id: string): Observable<any> {
    const params = new HttpParams().set('id', id);
    return this.apiService.delete<string>(
      `${this.appointmentsEndepoint.delete}?${params.toString()}`
    );
  }
